...
nginx-alp: ## Run alp
	@sudo alp ltsv --file /var/log/nginx/access.log --sort sum --reverse --matching-groups '/api/user/[a-zA-Z0-9]+/icon, /api/user/[a-zA-Z0-9]+/statistics, /api/livestream/[0-9]+/statistics, /api/livestream/[0-9]+/icon, /api/livestream/[0-9]+/reaction, /api/livestream/[0-9]+/ngwords, /api/livestream/[0-9]+/report, /api/livestream/[0-9]+/moderate, /api/livestream/[0-9]+/livecomment, /api/livestream/[0-9]+/livecomment/[0-9]+/report, /api/livestream/[0-9]+/enter, /api/livestream/[0-9]+/exit'> alp.txt
	@dispost -f alp.txt
